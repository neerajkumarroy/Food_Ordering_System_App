...
?>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright ©2023 <a class="grey-text text-lighten-4" href="#" target="_blank">HIT Students</a> All rights reserved!</span>
        <span class="right"> Design and Developed by Neeraj Kumar, <a class="grey-text text-lighten-4" href="#">HIT Students</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
